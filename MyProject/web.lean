...
:= by
{
    ...
    change ∫ x in Ω, (I_Squared_Term_Norm I x) - ρ * (IB_Inner I B x) * 2 + (B_Squared_Term_Norm B x ρ) = ( -(I_Squared_Term_Norm I B ρ lower upper Ω ) + ρ ^ 2 * ∫ x in Ω, ⟪∇ B x, ∇ B x⟫_ℝ) + (Int_I_Squared_Term I lower upper Ω)

    trace_state

    change ∫ x in Ω, (I_Squared_Term_Norm I x) - ρ * (IB_Inner I B x) * 2 + (B_Squared_Term_Norm B x ρ) = (-(Int_IB_Term_2 I B ρ lower upper Ω) + ρ ^ 2 * (Int_IB_Squared_Term I B ) + (Int_I_Squared_Term I lower upper Ω)


    /-
    change ∫ x in Ω, (I_Squared_Term I x) - (IB_Term I B x ρ) + (B_Squared_Term B x ρ) = (Int_B_Squared_Term B ρ lower upper Ω) - (ρ * ∫ x in Ω, deriv I x * deriv B x) * 2 + (Int_I_Squared_Term I lower upper Ω)
